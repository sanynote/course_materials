<?php
	...
	#02) DB와 현재 페이지 연결하기 (stdscore 테이블 연동하기)

	echo "<h2>DB와 페이지 연결하기, stdscore 테이블 이용하기</h2>";
	...
	*/
	...
	echo "이름: ".$row[1]." / 국어점수: ".$row[2]." / 영어점수: ".$row[3]." / 수학점수: ".$row[4]." / 총점: ".$row[5]." / 평균: ".$row[6]." <br/>";
