<?php
	...
	*/
	...
	if($carname !="" && $carprice !="" && $caryear !="" && $carcolor !=""){
		/*
			1) 요청할 sql 문 작성하기
		...
		*/
		$sql = "INSERT INTO cardesc (carname, carprice, caryear, carcolor) VALUES ('$carname', '$carprice', 
		'$caryear', '$carcolor')";
	...
	# 다음 페이지로 넘겨주기
	echo "<meta http-equiv='Refresh' content='1; 04_cardesc_result.php?nm=$carname && co=$carcolor'/>";
?>