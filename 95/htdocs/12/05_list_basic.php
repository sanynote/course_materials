...
<html lang="ko">
 <head>
	<title>list_basic</title>
	<meta charset="utf-8"/>
	<style>
		*{margin:0; padding:0;}
		body{margin:0; padding:0; font:12px/1.2em "Malgun Gothic"}
		a:link, a:visited{color:#333; text-decoration:none;}
		a:hover, a:focus{color:#fff; text-decoration:underline; color:#f00;}
		...
		/*
			table의 경우, td에 따라서 칸이 나뉘기 때문에 합쳐놓지 않으면
			글자가 오른쪽, 왼쪽, 가운데 정렬이 되지 않는다!

			* 테이블은 사용하지 않는 칸까지 계산해서 합쳐놓지 않으면 벽에 막혀서 사용하기 어려움!
		*/
