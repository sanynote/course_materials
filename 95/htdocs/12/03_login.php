 ...
 <head>
	...
	<style>
		*{margin:0; padding:0;}
		...
		form{width:300px; margin:0 auto; padding:10px 20px; box-shadow:3px 3px 20px rgba(0,0,0,0.1); font-size:12px;}
		...
		<form action="04_login_control.php" method="post">
			<fieldset>
				...
				<p>
					...
					<input id="userid" type="text" name="userid" maxlength="10" title="10자까지 입력가능" required/>
				</p>
				<p>
					<label for="userpass">비밀번호</label>
					<input id="userpass" type="password" name="userpass" maxlength="8" title="8자까지 입력가능" required/>
				</p>
				<p id="button">
